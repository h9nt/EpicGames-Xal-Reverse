(function () {
  var b = {
      ...
      a.exports = function (a) {
        return new Promise(function (b, c) {
          ...
          v.open(
            ...
            g(y, a.params, a.paramsSerializer),
            true
          );
          v.timeout = a.timeout;
          if ("onloadend" in v) {
          ...
          v.ontimeout = function () {
            ...
            c(
              new n(
                b,
                d.clarifyTimeoutError ? n.ETIMEDOUT : n.ECONNABORTED,
                a,
                v
              )
            );
          ...
          if (d.isStandardBrowserEnv()) {
            var A =
              (a.withCredentials || l(y)) && a.xsrfCookieName
                ? f.read(a.xsrfCookieName)
                : undefined;
            if (A) {
    ...
    3572: function (a, b, c) {
      ...
      a.exports = function (a) {
        ...
        return (a.adapter || g.adapter)(a).then(
          function (b) {
            j(a);
    ...
    5546: function (a, b, c) {
      ...
      var q = {
        ...
        transformRequest: [
          function (a, b) {
            ...
            if (e.isURLSearchParams(a)) {
              m(b, "application/x-www-form-urlencoded;charset=utf-8");
              return a.toString();
            }
            var c;
            var d = e.isObject(a);
            var g = b && b["Content-Type"];
            if ((c = e.isFileList(a)) || (d && g === "multipart/form-data")) {
              var h = this.env && this.env.FormData;
              var l = {
                "files[]": a,
              };
              return j(c ? l : a, h && new h());
            }
            if (d || g === "application/json") {
        ...
        transformResponse: [
          function (a) {
            var b = this.transitional || q.transitional;
            var c = b && b.silentJSONParsing;
            var d = b && b.forcedJSONParsing;
            var f = !c && this.responseType === "json";
            if (f || (d && e.isString(a) && a.length)) {
              try {
                return JSON.parse(a);
              } catch (a) {
                if (f) {
      ...
      c = {
        ...
        base64ToBytes: function (a) {
          ...
          for (var d = 0, e = 0; d < a.length; e = ++d % 4) {
            if (e != 0) {
              c.push(
                ((b.indexOf(a.charAt(d - 1)) & (Math.pow(2, e * -2 + 8) - 1)) <<
                  (e * 2)) |
                  (b.indexOf(a.charAt(d)) >>> (6 - e * 2))
              );
            }
          }
          return c;
    ...
    2568: function (a, b, c) {
      ...
      (h = function (a, b) {
        ...
        for (p = 0; p < c.length; p += 16) {
          ...
          l = r(
            l,
            (m = q(m, n, o, l, c[p + 15], 22, 1236535329)),
            n,
            o,
            c[p + 1],
            5,
          ...
          l = s(
            l,
            (m = r(m, n, o, l, c[p + 12], 20, -1926607734)),
            n,
            o,
            c[p + 5],
            4,
          ...
          l = t(
            l,
            (m = s(m, n, o, l, c[p + 2], 23, -995338651)),
            n,
            o,
            c[p + 0],
            6,
    ...
    641: function (a, b, c) {
      ...
      a.exports = function (a, b, c, e) {
        ...
        this.calculateDifference = function (d, f) {
          ...
          return (
            (g += a.calculateDifference(d.getChecksum())) +
            e.calculateDifference(d.getBody())
          );
        };
    ...
    7061: function (a, b, c) {
      ...
      function e() {
          ...
          function c(e, g, h, j) {
            ...
            if (l.type !== "throw") {
              ...
              if (n && d(n) == "object" && f.call(n, "__await")) {
                return b.resolve(n.__await).then(
                  function (a) {
                    c("next", a, h, j);
                  },
                  function (a) {
        ...
        b.isGeneratorFunction = function (a) {
          ...
          return (
            !!b &&
            (b === r || (b.displayName || b.name) === "GeneratorFunction")
          );
        };
        b.mark = function (a) {
  ...
  (function () {
    ...
    function p(a) {
      for (var b = 1; b < arguments.length; b++) {
        var c = arguments[b] ?? {};
        if (b % 2) {
          o(Object(c), true).forEach(function (b) {
            q(a, b, c[b]);
          });
    ...
    function s(a) {
      return (
        !a.response && Boolean(a.code) && a.code !== "ECONNABORTED" && l(a)
      );
    }
    var t = ["get", "head", "options"];
    var u = t.concat(["put", "delete"]);
    function v(a) {
      return (
        a.code !== "ECONNABORTED" &&
    ...
    function w(a) {
      return !!a.config && v(a) && u.indexOf(a.config.method) !== -1;
    }
    function x(a) {
      return s(a) || w(a);
    }
            ...
            function (e) {
              while (true) {
                switch ((e.prev = e.next)) {
                  case 0:
                    if (j((g = c.retryCount < a && b(d))) !== "object") {
                      e.next = 12;
                      break;
                    }
                    e.prev = 2;
    ...
    F.isNetworkError = s;
    F.isSafeRequestError = function (a) {
      return !!a.config && v(a) && t.indexOf(a.config.method) !== -1;
    };
    F.isIdempotentRequestError = w;
    F.isNetworkOrIdempotentRequestError = x;
    F.exponentialDelay = z;
    F.isRetryableError = v;
    var I = {
            ...
            function (a) {
              while (true) {
                switch ((a.prev = a.next)) {
                  case 0:
                    b = {};
                    O.drain().forEach(function (a) {
                      if (a != null && a.event) {
                        var c = G(a == null ? undefined : a.env);
                        if (b[c]) {
                          b[c].push(a.event);
                        } else {
                          b[c] = [a.event];
                  ...
                  case 3:
                    ...
                    F(
                      ...
                      })),
                      {
                        ...
                        retryCondition: function (a) {
                          return (
                            F.isNetworkOrIdempotentRequestError(a) ||
                            a.code === "ECONNABORTED"
                          );
                        },
                        retryDelay: z,
                    ...
                    a.next = 13;
                    return e.post("/v1/phaser/batch", d, {
    ...
    function Z() {
      try {
        ...
        U(talon.env, P, talon.session, a.message, a.stack);
      }
    }
    function $() {
      var a;
    ...
    function ga() {
      try {
        ...
        var c =
          "👾 https://www.epicgames.com/site/en-US/careers ðŸ”’ https://hackerone.com/epicgames ðŸ•¹ï¸";
        b.font = "14px 'Arial'";
        b.fillStyle = "#333";
        ...
        var e = a.toDataURL();
        for (
          var f = b.getImageData(0, 0, 600, 50), g = {}, h = 0;
          h < f.data.length;
          h += 4
        ) {
          var j =
            f.data[h].toString(16) +
            f.data[h + 1].toString(16) +
            f.data[h + 2].toString(16) +
            f.data[h + 3].toString(16);
          if (g[j]) {
            g[j]++;
          } else {
            g[j] = 1;
    ...
    function ha() {
      ...
      try {
        ...
        var b =
          a.getContext("webgl2") ||
          a.getContext("webgl") ||
          a.getContext("experimental-webgl2") ||
          a.getContext("experimental-webgl");
        if (!b) {
          return {
            canvas_fingerprint: ga(),
          };
        }
                  ...
                  return a.abrupt("return", {
                    ...
                    property_list:
                      ...
                      (function () {
                        ...
                        for (
                          var a = Math.floor(Math.random() * 100), b = 0;
                          b < a;
                          b++
                        ) {
    ...
    function Aa(a, b, c = 16) {
      return ta(this, undefined, undefined, function () {
        var d;
        var e;
        var f;
        var g;
        return ua(this, function (h) {
          switch (h.label) {
            case 0:
              d = Array(a.length);
              e = Date.now();
    ...
    function Ha(a) {
      a = Ga(a, [0, a[0] >>> 1]);
      a = Ga((a = Da(a, [4283543511, 3981806797])), [0, a[0] >>> 1]);
      return Ga((a = Da(a, [3301882366, 444984403])), [0, a[0] >>> 1]);
    }
    function Ia(a) {
      return parseInt(a);
    }
    ...
    function Qa() {
      ...
      return (
        La([
          ...
          "webkitResolveLocalFileSystemURL" in a,
          "BatteryManager" in a,
          "webkitMediaStream" in a,
          "webkitSpeechGrammar" in a,
        ]) >= 5
      );
    }
    function Ra() {
    ...
    function Ua() {
      ...
      return (
        La([
          ...
          "orientation" in c,
          a && !("SharedWorker" in c),
          b && /android/i.test(navigator.appVersion),
        ]) >= 2
      );
    }
    function Va(a) {
              ...
              return [
                ...
                new Promise(function (a, c) {
                  ...
                  function j() {
                    if (!d) {
                      if (
                        f.contentWindow?.document?.readyState === "complete"
                      ) {
                        g();
                      } else {
                        setTimeout(j, 10);
    ...
    var Za;
    var $a;
    var _a = ["monospace", "sans-serif", "serif"];
    var ab = [
      "sans-serif-thin",
      "ARNO PRO",
      "Agency FB",
    ...
    function cb() {
      var a = screen;
      return [
        Ka(Ja(a.availTop), null),
        Ka(Ja(a.width) - Ja(a.availWidth) - Ka(Ja(a.availLeft), 0), null),
        Ka(Ja(a.height) - Ja(a.availHeight) - Ka(Ja(a.availTop), 0), null),
        Ka(Ja(a.availLeft), null),
      ];
    }
    function db(a) {
      for (var b = 0; b < 4; ++b) {
        ...
        return ua(this, function (l) {
          switch (l.label) {
            case 0:
              ...
              j = 0;
              for (; j < a.length; ++j) {
                if ((g = Xa(a[j])).tagName === "DIALOG") {
                  g.show();
                }
                fb((h = c.createElement("div")));
                h.appendChild(g);
                d.appendChild(h);
                e[j] = g;
              }
      ...
      fonts: function () {
        return Wa(function (a, b) {
          ...
          var l = (function () {
            var a = {};
            var b = function (b) {
              a[b] = _a.map(function (a) {
                return (function (a, b) {
                  return h(`'${a}',${b}`);
                })(b, a);
              });
            };
            for (var c = 0, d = ab; c < d.length; c++) {
              b(d[c]);
            }
            return a;
          })();
          ...
          for (var m = 0; m < _a.length; m++) {
            f[_a[m]] = j[m].offsetWidth;
            g[_a[m]] = j[m].offsetHeight;
          }
          return ab.filter(function (a) {
            b = l[a];
            return _a.some(function (a, c) {
              ...
              case 0:
                if (Ra() || Ua()) {
                  ...
                  a = {
                    ...
                    estonian: [
                      h("QVtocmVmKj0iaHR0cDovL3BheTRyZXN1bHRzMjQuZXUiXQ=="),
                    ],
                    fanboyAnnoyances: [
                      "#ac-lre-player",
                      ".navigate-to-top",
  ...
  \`\`\``);
      ...
      fontPreferences: function () {
        ...
        return Wa(function (b, c) {
          ...
          g.textContent = va([], Array((a / 20) << 0), true)
            .map(function () {
              return "word";
            })
            .join(" ");
          ...
          return (function (a, b) {
            var c = {};
            var d = {};
            for (var e = 0, f = Object.keys(ub); e < f.length; e++) {
              var g = f[e];
              var h = ub[g];
              var j = h[0];
              var l = j === undefined ? {} : j;
            ...
            for (var t = 0, u = Object.keys(ub); t < u.length; t++) {
      ...
      screenFrame: function () {
        ...
        var b = (function () {
          ...
          return function () {
            return ta(a, undefined, undefined, function () {
              var a;
      ...
      languages: function () {
        ...
        var c = [];
        var d =
          b.language || b.userLanguage || b.browserLanguage || b.systemLanguage;
        if (d !== undefined) {
          c.push([d]);
        }
      ...
      deviceMemory: function () {
        return Ka(Ja(navigator.deviceMemory), undefined);
      },
      ...
      hardwareConcurrency: function () {
        return Ka(Ia(navigator.hardwareConcurrency), undefined);
      },
      timezone: function () {
        ...
        var d = -Math.max(
          Ja(new Date(c, 0, 1).getTimezoneOffset()),
          Ja(new Date(c, 6, 1).getTimezoneOffset())
        );
      ...
      invertedColors: function () {
        return !!gb("inverted") || (!gb("none") && undefined);
      },
      forcedColors: function () {
        return !!hb("active") || (!hb("none") && undefined);
      },
      monochrome: function () {
      ...
      contrast: function () {
        if (ib("no-preference")) {
          return 0;
        } else if (ib("high") || ib("more")) {
          return 1;
        } else if (ib("low") || ib("less")) {
          return -1;
        } else if (ib("forced")) {
          return 10;
        } else {
      ...
      reducedMotion: function () {
        return !!jb("reduce") || (!jb("no-preference") && undefined);
      },
      hdr: function () {
        return !!kb("high") || (!kb("standard") && undefined);
      },
      math: function () {
        var a;
        var b = sb.acos || tb;
        ...
        return {
          ...
          acosh: c(1e308),
          acoshPf: ((a = 1e154), sb.log(a + sb.sqrt(a * a - 1))),
          asin: d(0.12312423423423424),
          asinh: e(1),
          asinhPf: sb.log(1 + sb.sqrt(2)),
          atanh: f(0.5),
          atanhPf: sb.log(3) / 2,
          atan: g(0.5),
          sin: h(-1e300),
          sinh: j(1),
          sinhPf: sb.exp(1) - 1 / sb.exp(1) / 2,
          cos: l(10.000000000123),
          cosh: m(1),
          coshPf: (sb.exp(1) + 1 / sb.exp(1)) / 2,
          tan: n(-1e300),
          tanh: o(1),
          tanhPf: (sb.exp(2) - 1) / (sb.exp(2) + 1),
          exp: p(1),
          expm1: q(1),
          expm1Pf: sb.exp(1) - 1,
          log1p: r(10),
          log1pPf: sb.log(11),
          powPI: sb.pow(sb.PI, -100),
        };
      },
      videoCard: function () {
        var a = document.createElement("canvas");
        ...
        if (b && "getExtension" in b) {
          ...
          if (c) {
            return {
              vendor: (
                b.getParameter(c.UNMASKED_VENDOR_WEBGL) || ""
              ).toString(),
              renderer: (
                b.getParameter(c.UNMASKED_RENDERER_WEBGL) || ""
              ).toString(),
            };
          }
        }
    ...
    function yb(a) {
      return (function (a, b) {
        ...
        for (c = 0; c < e; c += 16) {
          ...
          h = Ea((h = Da(h, l)), 31);
          f = Ca((f = Ea((f = Ga(f, (h = Da(h, m)))), 27)), g);
          f = Ca(Da(f, [0, 5]), [0, 1390208809]);
          j = Ea((j = Da(j, m)), 33);
          g = Ca((g = Ea((g = Ga(g, (j = Da(j, l)))), 31)), f);
          g = Ca(Da(g, [0, 5]), [0, 944331445]);
        }
        h = [0, 0];
        j = [0, 0];
        switch (d) {
          case 15:
            j = Ga(j, Fa([0, a.charCodeAt(c + 14)], 48));
          case 14:
            j = Ga(j, Fa([0, a.charCodeAt(c + 13)], 40));
          case 13:
            j = Ga(j, Fa([0, a.charCodeAt(c + 12)], 32));
          case 12:
            j = Ga(j, Fa([0, a.charCodeAt(c + 11)], 24));
          case 11:
            j = Ga(j, Fa([0, a.charCodeAt(c + 10)], 16));
          case 10:
            j = Ga(j, Fa([0, a.charCodeAt(c + 9)], 8));
          case 9:
            j = Da((j = Ga(j, [0, a.charCodeAt(c + 8)])), m);
            g = Ga(g, (j = Da((j = Ea(j, 33)), l)));
          case 8:
            h = Ga(h, Fa([0, a.charCodeAt(c + 7)], 56));
          case 7:
            h = Ga(h, Fa([0, a.charCodeAt(c + 6)], 48));
          case 6:
            h = Ga(h, Fa([0, a.charCodeAt(c + 5)], 40));
          case 5:
            h = Ga(h, Fa([0, a.charCodeAt(c + 4)], 32));
          case 4:
            h = Ga(h, Fa([0, a.charCodeAt(c + 3)], 24));
          case 3:
            h = Ga(h, Fa([0, a.charCodeAt(c + 2)], 16));
          case 2:
            h = Ga(h, Fa([0, a.charCodeAt(c + 1)], 8));
          case 1:
            h = Da((h = Ga(h, [0, a.charCodeAt(c)])), l);
            f = Ga(f, (h = Da((h = Ea(h, 31)), m)));
        }
        f = Ca((f = Ga(f, [0, a.length])), (g = Ga(g, [0, a.length])));
        g = Ca(g, f);
        f = Ca((f = Ha(f)), (g = Ha(g)));
        g = Ca(g, f);
        return (
  ...
  \`\`\``);
                  ...
                  (function () {
                    if (!window.__fpjs_d_m && Math.random() < 0.001) {
                      try {
                        ...
                        a.open(
                          "get",
                          `https://m1.openfpcdn.io/fingerprintjs/v${wa}/npm-monitoring`,
                          true
                        );
                        a.send();
                      } catch (a) {
              ...
              case 1:
                ...
                a = (function (a) {
                  return (function (a, b, c) {
                    ...
                    var e = Aa(d, function (c) {
                      return (function (a, b) {
                        var c = new Promise(function (c) {
                          var d = Date.now();
                          za(a.bind(null, b), function () {
                            var a = [];
              ...
              while (true) {
                switch ((a.prev = a.next)) {
                  ...
                  case 10:
                    a.prev = 10;
                    a.t0 = a.catch(0);
                    U(talon.env, P, talon.session, a.t0.message, a.t0.stack);
                  case 13:
                  case "end":
                    return a.stop();
                }
    ...
    var Db = {
      mousemove: new L(500, 50),
      mousedown: new L(50),
      mouseup: new L(50),
      wheel: new L(100, 50),
      touchstart: new L(50),
      touchend: new L(50),
      touchmove: new L(500, 50),
      scroll: new L(50),
      keydown: new L(50),
      keyup: new L(50),
      resize: new L(50),
    ...
    function Eb() {
      var a = {};
      Object.keys(Db).forEach(function (b) {
        a[b] = Db[b].peek();
      });
      return a;
    }
              ...
              while (true) {
                switch ((a.prev = a.next)) {
                  ...
                  case 3:
                    ...
                    if (
                      (c = new WebAssembly.Module(b)) instanceof
                      WebAssembly.Module
                    ) {
                      a.next = 7;
                      break;
                  ...
                  case 9:
                    ...
                    return a.abrupt(
                      "return",
                      d instanceof WebAssembly.Instance
                    );
                  case 13:
                    a.prev = 13;
                    a.t0 = a.catch(0);
    ...
    function Ib(a) {
      for (var b = 1; b < arguments.length; b++) {
        var c = arguments[b] ?? {};
        if (b % 2) {
          Hb(Object(c), true).forEach(function (b) {
            X(a, b, c[b]);
          });
        } else if (Object.getOwnPropertyDescriptors) {
          Object.defineProperties(a, Object.getOwnPropertyDescriptors(c));
        } else {
          Hb(Object(c)).forEach(function (b) {
            Object.defineProperty(a, b, Object.getOwnPropertyDescriptor(c, b));
          });
        }
      }
    ...
    var key = "FZMÃ›SÃª/Â·V«xÞhí¢³4<`ô2ª,µ¦YÃ»";
    var Lb = "aRAejw";
    function Mb(a, b) {
              ...
              while (true) {
                switch ((c.prev = c.next)) {
                  ...
                  case 17:
                    c.prev = 17;
                    c.t10 = c.catch(0);
                    U(talon.env, P, talon.session, c.t10.message, c.t10.stack);
                  case 20:
                  case "end":
                    return c.stop();
                }
    ...
    var gc = {
      ...
      challengeSubtitle:
        "Bitte fÃ¼hre eine Sicherheitskontrolle aus, um fortzufahren.",
    ...
    var mc = {
      ...
      challengeSubtitle:
        "継続するにはセキュリãƒ†ã‚£ãƒã‚§ãƒƒã‚¯ã‚’å®Œäº†ã—てください",
    ...
    var pc = {
      ...
      challengeSubtitle:
        "Complete uma verificação de seguranÃ§a para continuar",
    ...
    var qc = {
      ...
      challengeSubtitle:
        "Перед тем как продолÐ¶Ð¸Ñ‚ÑŒ, Ð·Ð°Ð²ÐµÑ€ÑˆÐ¸Ñ‚Ðµ Ð¿Ñ€Ð¾Ð²ерку безопасности",
    ...
    var tc = {
      ...
      th: {
        ...
        challengeSubtitle:
          "à¹‚à¸›à¸£à¸”à¸—à¸³à¸à¸²à¸£à¸•à¸£à¸§à¸ˆà¸ªà¸­à¸šà¸„à¸§à¸²à¸¡ปลอดภัยให้เสร็จเพื่อดำเนินการตà¹ˆà¸­",
      ...
      tr: {
        ...
        challengeSubtitle:
          "Devam etmek için lütfen bir güvenlik kontrolÃ¼nÃ¼ tamamla",
        sessionID: "Oturum NO",
        ipAddress: "IP Adresi",
    ...
    var Gc = d(6452);
    var Hc = {};
    Hc.styleTagTransform = Fc();
    Hc.setAttributes = Bc();
    Hc.insert = zc().bind(null, "head");
    Hc.domAPI = xc();
    Hc.insertStyleElement = Dc();
    vc()(Gc.Z, Hc);
    if (Gc.Z && Gc.Z.locals) {
      Gc.Z.locals;
    }
        ...
        return Oc(this, function (f) {
          switch (f.label) {
            ...
            case 1:
              ...
              Jc("[nelly] discovering task", (d = c[b]));
              f.label = 2;
            case 2:
              f.trys.push([2, 4, , 5]);
              return [4, Pc.get(d)];
            case 3:
              e = f.sent();
              Jc("[nelly] discovered task", d);
              return [2, e.data];
            case 4:
              Kc("[nelly] error fetching discovery url", f.sent());
              return [3, 5];
            case 5:
              b++;
              return [3, 1];
      ...
      return Nc(this, undefined, undefined, function () {
        ...
        return Oc(this, function (h) {
          switch (h.label) {
            ...
            case 4:
              h.sent();
              Jc("[nelly] report acknowledged");
              return [2];
            case 5:
              Kc("[nelly] error sending report", h.sent());
      ...
      return Nc(this, undefined, undefined, function () {
        ...
        return Oc(this, function (s) {
          switch (s.label) {
            ...
            case 2:
              s.sent();
              Jc("[nelly] starting task", q.endpoint);
              e = {
                provider: q.provider,
                successful: false,
              };
            ...
            case 4:
              s.sent();
              e.successful = true;
              Jc("[nelly] task completed", q.endpoint);
              return [3, 6];
            case 5:
              f = s.sent();
              g = f;
              e.error = g.message;
              Kc("[nelly] error sending report", q.endpoint, f);
              return [3, 6];
            case 6:
              b[q.task_id] = e;
              s.label = 7;
        ...
        return (function (a, b) {
          ...
          switch (e.label) {
            ...
            case 2:
              ...
              return [4, Qc(b)];
            case 3:
              return [4, a.apply(undefined, [e.sent(), c])];
            case 4:
              e.sent();
              return [3, 6];
            case 5:
              Kc("[nelly] failed to discover nelly task", e.sent());
              return [3, 6];
            case 6:
              Jc("[nelly] nelly complete");
              return [2];
          }
        });
      };
      return new ((g = undefined) || (g = Promise))(function (b, c) {
        function d(b) {
          try {
            l(h.next(b));
          } catch (a) {
    ...
    function bd(a) {
      ...
      window.talon.flows[a.flow] = {
        ...
        loadWatchdog: setTimeout(function () {
          var b = ad(a.flow);
          T(b.config.env, "sla_miss_ready", b.session);
        }, 15000),
      };
      (function (a) {
          ...
          return Yc(this, function (l) {
            switch (l.label) {
              ...
              case 1:
                ...
                g = e.config;
                j = ad(a.flow);
                T(a.env, "sdk_init_complete", j.session);
                (function (a) {
              ...
              case 2:
                return [4, cd(0, g.h_captcha_config)];
              case 3:
                l.sent();
                return [4, fd(j)];
              case 4:
                ...
                return [3, 5];
              case 5:
                ad(a.flow).ready = true;
                T(a.env, "challenge_ready", j.session);
                if (j.loadWatchdog) {
        ...
        return Yc(this, function (d) {
          switch (d.label) {
            ...
            case 2:
              ...
              a = (b == null ? undefined : b.sdk_base_url)
                ? b == null
                  ? undefined
                  : b.sdk_base_url
              ...
              if (b == null ? undefined : b.sdk_endpoint) {
                c += `&endpoint=${encodeURIComponent(
                  b == null ? undefined : b.sdk_endpoint
                )}`;
              }
              if (b == null ? undefined : b.sdk_img_host) {
                c += `&imghost=${encodeURIComponent(
                  b == null ? undefined : b.sdk_img_host
                )}`;
              }
              if (b == null ? undefined : b.sdk_report_api) {
                c += `&reportapi=${encodeURIComponent(
                  b == null ? undefined : b.sdk_report_api
                )}`;
              }
              if (b == null ? undefined : b.sdk_asset_host) {
                c += `&assethost=${encodeURIComponent(
                  b == null ? undefined : b.sdk_asset_host
                )}`;
              }
              return [
                4,
                ((e = `${a}/1/api.js?onload=hCaptchaLoaded&render=explicit${c}`),
    ...
    function ed(a, b) {
      var c = document.getElementById(
        `talon_container_${a.session.session.flow_id}`
      );
      if (b !== a.open) {
        if (b) {
          T(a.config.env, "challenge_opened", a.session);
          ...
          T(a.config.env, "challenge_closed", a.session);
    ...
    function fd(a) {
      if (!a.ready) {
        ...
        a.widgetID = window.hcaptcha.render(
          `h_captcha_checkbox_${a.session.session.flow_id}`,
          {
            ...
            "error-callback": function (b) {
              if (b === "challenge-error") {
                ed(a, true);
                T(a.config.env, "challenge_rejected_answer", a.session);
                id(a.config.flow);
              } else {
                ed(a, true);
                U(a.config.env, "challenge_error", a.session, b, null);
                document.getElementById(
                  `talon_error_container_${a.config.flow}`
                ).style.display = "flex";
                document.getElementById(
                  `talon_error_message_${a.config.flow}`
                ).innerText = b;
              }
            },
        ...
        return Yc(this, function (e) {
          switch (e.label) {
            case 0:
              ...
              return [4, Mb({}, true)];
            case 1:
              c = Wc.apply(undefined, d.concat([e.sent()]));
              T(a.config.env, "challenge_complete", a.session);
              ed(a, false);
              if (a.executeWatchdog) {
                clearTimeout(a.executeWatchdog);
              }
    ...
    function id(a, b) {
      ...
      var c = ad(a);
      T(c.config.env, "sdk_execute", c.session);
      c.executeWatchdog = setTimeout(function () {
        var b = ad(a);
        T(b.config.env, "sla_miss_execute", b.session);
      }, 15000);
      var d = b;
      if (b) {
        c.formData = b;
          ...
          return Yc(this, function (n) {
            switch (n.label) {
              ...
              case 2:
                c = {};
                if (
                  a.session.session.config.acid &&
                  a.session.session.config.acid.includes("argon")
                ) {
                  c["X-Acid-Argon"] = a.session.session.id;
                }
                d = h().create({
                  baseURL: $c[_c(a.config.env)],
                  timeout: 25000,
                });
                g = (f = d).post;
                j = ["/v1/init/execute"];
              ...
              case 3:
                ...
                return [
                  ...
                  g.apply(
                    f,
                    j.concat([Wc.apply(undefined, l.concat([n.sent()])), o])
                  ),
                ];
              case 4:
                e = n.sent();
                m = e.data;
                T(a.config.env, "challenge_execute", a.session);
                if (a.session.session.plan.mode === "h_captcha") {
                  (function (a, b) {
                    var c = {
    ...
    function kd(a, b) {
      U(
        (b == null ? undefined : b.config.env) || "prod",
        P,
        b == null ? undefined : b.session,
        a.message,
        a.stack
      );
      if (b.config.onError) {
      ...
      window.talon = {
        ...
        reset: function (a) {
          ...
          if (b.session && b.config.onReady) {
            ...
            kd(
              new Error(
                `'attempting to reset flow_id "${a}" that is not initialized`
              ),
              undefined
            );
          }
                  ...
                  switch (a.type) {
                    ...
                    case "paste":
                      return [
                        {
                          t: a.timeStamp,
                          tg: `${a.target.tagName.toLowerCase()}#${
                            a.target.id
                          }${Object.values(a.target.classList).join(".")}`,
                        },
                      ];
                    default:
                      return [c];
    ...
    async function getFp() {
      ...
      document.getElementById("xal_rev").innerHTML = JSON.stringify(
        result,
        null,
        2
      );
